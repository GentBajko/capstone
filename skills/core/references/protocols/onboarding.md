...
**Reads:** config → `<index_file>` → the load-bearing files the tour
will cite → the existing `onboarding.md` stamp before overwriting.

Output: `docs/capstone/onboarding.md`, frontmatter stamps. A guided tour
